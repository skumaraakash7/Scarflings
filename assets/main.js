! function(o) {
    ...
    var d = o(".topbar").height(),
        s = o(".container-menu-header");
    o(window).on("scroll", function() {
      //hide cart and dim background on scroll  
      //$('.pgmsk').hide();
	  //$(".header-dropdown").removeClass("show-header-dropdown");      
        
      
        if (o(this).scrollTop() >= d) o(".header1").addClass("fixed-header"), o(s).css("top", -d);
        else {
            var e = -o(this).scrollTop();
            o(s).css("top", e), o(".header1").removeClass("fixed-header")
        }
...
o(this).scrollTop() >= 200 && o(window).width() > 992 ? (o(".wrap_header").addClass("fixed-header2 show-fixed-header2"),o(".stkylogo").show()) : (o(".wrap_header").removeClass("fixed-header2 show-fixed-header2"),o(".stkylogo").hide())    
 
        
    }), o(".btn-show-menu-mobile").on("click", function() {
        o(this).toggleClass("is-active"), o(".wrap-side-menu").slideToggle(), o("html").toggleClass("menu-open")
    ...
    var a = o(".video-mo-01").children("iframe").attr("src");
    o('[data-target="#modal-video-01"]').on("click", function() {
        ...
        o(".video-mo-01").children("iframe")[0].src = a, o(".video-mo-01").css("opacity", "1")
    })
}(jQuery);
